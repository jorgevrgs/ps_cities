...
class AdminCitiesController extends ModuleAdminController
{
    public function __construct()
    {
        ...
        $this->fields_list = array(
            'id_city' => array(
                'title' => $this->trans('ID', array(), 'Modules.Envia.City'),
                'align' => 'center',
                'class' => 'fixed-width-xs',
            ),
            'name' => array(
                'title' => $this->trans('Name', array(), 'Modules.Envia.City'),
                'filter_key' => 'a!name',
            ),
            'iso_code' => array(
            ...
            'zone' => array(
                'title' => $this->trans('Zone', array(), 'Modules.Envia.City'),
                'type' => 'select',
                'list' => $zones_array,
            ...
            'state' => array(
                'title' => $this->trans('State', array(), 'Modules.Envia.City'),
                'type' => 'select',
                'list' => $states_array,
            ...
            'country' => array(
                'title' => $this->trans('Country', array(), 'Modules.Envia.City'),
                'type' => 'select',
            ...
            'active' => array(
                'title' => $this->trans('Enabled', array(), 'Modules.Envia.City'),
                'active' => 'status',
                'filter_key' => 'a!active',
                'align' => 'center',
                'type' => 'bool',
    ...
    public function initPageHeaderToolbar()
    {
        if (empty($this->display)) {
            $this->page_header_toolbar_btn['new_city'] = array(
                ...
                'desc' => $this->trans('Add new city', array(), 'Admin.International.Feature'),
    ...
    public function renderForm()
    {
        $this->fields_form = array(
            'legend' => array(
                'title' => $this->trans('Cities', array(), 'Admin.International.Feature'),
                'icon' => 'icon-globe',
            ),
            'input' => array(
                array(
                    'type' => 'text',
                    'label' => $this->trans('Name', array(), 'Modules.Envia.City'),
                    'name' => 'name',
                    'maxlength' => 32,
                    'required' => true,
                    'hint' => $this->trans('Provide the city name to be displayed in addresses and on invoices.', array(), 'Admin.International.Help'),
                ),
                array(
                    'type' => 'text',
                ...
                array(
                    'type' => 'select',
                    'label' => $this->trans('Country', array(), 'Modules.Envia.City'),
                    'name' => 'id_country',
                    'required' => true,
                    ...
                    'hint' => $this->trans('Country where the city is located.', array(), 'Admin.International.Help').' '.$this->trans('Only the countries with the option "contains cities" enabled are displayed.', array(), 'Admin.International.Help'),
                ),
                array(
                    'type' => 'select',
                    'label' => $this->trans('State', array(), 'Modules.Envia.City'),
                    'name' => 'id_state',
                    'required' => true,
                    'options' => array(
                        'query' => State::getStates($this->context->language->id, true),
                        'id' => 'id_state',
                        'name' => 'name',
                    ),
                    'hint' => $this->trans('Country where the city is located.', array(), 'Admin.International.Help').' '.$this->trans('Only the countries with the option "contains cities" enabled are displayed.', array(), 'Admin.International.Help'),
                ...
                array(
                    'type' => 'select',
                    'label' => $this->trans('Zone', array(), 'Modules.Envia.City'),
                    'name' => 'id_zone',
                    'required' => true,
                    'options' => array(
                        'query' => Zone::getZones(),
                    ...
                    'hint' => array(
                        $this->trans('Geographical region where this city is located.', array(), 'Admin.International.Help'),
                        $this->trans('Used for shipping', array(), 'Admin.International.Help'),
                    ),
                ),
                array(
                    'type' => 'switch',
                    'label' => $this->trans('Status', array(), 'Modules.Envia.City'),
                    'name' => 'active',
                    'required' => true,
                    'values' => array(
                        array(
                            'id' => 'active_on',
                            'value' => 1,
                            'label' => '<img src="../img/admin/enabled.gif" alt="'.$this->trans('Enabled', array(), 'Modules.Envia.City').'" title="'.$this->trans('Enabled', array(), 'Modules.Envia.City').'" />',
                        ),
                        array(
                            'id' => 'active_off',
                            'value' => 0,
                            'label' => '<img src="../img/admin/disabled.gif" alt="'.$this->trans('Disabled', array(), 'Modules.Envia.City').'" title="'.$this->trans('Disabled', array(), 'Modules.Envia.City').'" />',
                        ),
                    ),
                ),
            ),
